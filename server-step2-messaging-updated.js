// Step 2: Updated server with message sending API and correct file serving
...
// STEP 2: Updated file serving routes
app.get('/app.js', (req, res) => {
    const appJsPath = path.join(__dirname, 'app-step2-messaging.js');
    console.log('📄 Step 2: Serving app-step2-messaging.js from:', appJsPath);
    
    if (fs.existsSync(appJsPath)) {
        res.setHeader('Content-Type', 'application/javascript; charset=utf-8');
        res.setHeader('Cache-Control', 'no-cache');
        res.sendFile(appJsPath);
        console.log('✅ app-step2-messaging.js served successfully');
    } else {
        console.error('❌ app-step2-messaging.js not found');
        res.status(404).send('app-step2-messaging.js not found');
    }
});

// Serve the Step 2 index.html
app.get('/', (req, res) => {
    const indexPath = path.join(__dirname, 'index-step2-messaging.html');
    console.log('📄 Step 2: Serving index-step2-messaging.html from:', indexPath);
    
    if (fs.existsSync(indexPath)) {
        res.sendFile(indexPath);
        console.log('✅ index-step2-messaging.html served successfully');
    } else {
        console.error('❌ index-step2-messaging.html not found, falling back to index.html');
...
app.get('/health', (req, res) => {
    res.json({
        ...
        files: {
            'app.js': 'app-step2-messaging.js',
            'index.html': 'index-step2-messaging.html'
        },
...
server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log('📄 Serving: index-step2-messaging.html and app-step2-messaging.js');
